<section class="txt-media-container media-txt">

    <div class="flex-module flex-media-txt l-wrapper<?php ew_flex_settings_sizes(); ?>grid <?php ew_help_field('ew_settings_content_division', true); ?>">
