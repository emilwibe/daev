<section class="flex-module flex-hero l-wrapper <?php ew_flex_settings_sizes(); ?> <?php ew_help_field('ew_daev_flex_section_overlay', true); ?>" style="<?php ew_style_print('ew_daev_flex_section_background_color', 'background-color', true); ?>">

    <div class="<?php if (get_sub_field('ew_daev_flex_section_background_color') || get_sub_field('ew_daev_flex_section_background_image') || get_sub_field('ew_daev_flex_section_background_video')) {
                                                                                                                                                        echo 'section-bg';
                                                                                                                                                    }; ?>">
